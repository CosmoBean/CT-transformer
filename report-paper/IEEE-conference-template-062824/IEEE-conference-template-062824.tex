...
\caption{Two YOLO-support examples used in the final workflow. Left: a clean single-label case where YOLO correctly localizes \textit{Aortic enlargement}. Right: a multi-label case where YOLO correctly localizes \textit{Aortic enlargement}, \textit{Cardiomegaly}, and \textit{Nodule/Mass}, while the more diffuse \textit{Lung Opacity} finding remains classifier-driven.}
