...
Five representative example reports covering all three conflict regimes, together with their ground-truth comparison outputs, are included in the \texttt{reports/example\_reports/} and \texttt{reports/comparision\_reports/} directories of the source code submission for direct reference.
