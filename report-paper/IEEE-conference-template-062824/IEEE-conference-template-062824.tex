...
\section{Results}
\subsection{Image-Level Classification}
Table~\ref{tab:classification} and Fig.~\ref{fig:clfcomp} summarize the classifier comparison. The main pattern is that transfer learning clearly helps on this dataset. Swin achieves the strongest performance at 0.9665 macro AUC-ROC, followed closely by EfficientNet-B3 (0.9564) and ResNet-50 (0.9550). The ViT baseline underperforms at 0.8143, likely due to insufficient data and epochs for a vanilla ViT to learn useful patch-level representations without the inductive biases that CNNs and Swin provide.
