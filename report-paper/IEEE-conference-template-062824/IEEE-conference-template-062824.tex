...
Five representative example reports spanning all three conflict regimes are included in the source submission for direct reference. Doctor-facing examples are provided in \texttt{reports/example\_reports/}, and ground-truth comparison examples are provided in \texttt{reports/comparision\_reports/}.
